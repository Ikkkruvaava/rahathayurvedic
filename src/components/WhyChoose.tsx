    ...
    const reasons = [
        {
            ...
            title: "Own Preparation Process",
            description: "We handle every step from sourcing to grinding."
        },
        {
            icon: (
            ...
            description: "Specialized traditional herbal support for comfort."
        },
        {
            icon: (
            ...
            title: "Near Hospital Junction",
            description: "Conveniently located in the heart of Mannarkkad."
        },
        {
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
            ),
            title: "5+ Years Local Trust",
            description: "Serving the community with authentic herbs."
        }
    ];
        ...
        <section id="why-choose" style={{ background: 'var(--white)' }}>
            <div className="container">
                <div className="text-center" style={{ marginBottom: '60px' }}>
                    <h2 style={{ fontSize: '2.5rem', marginBottom: '16px' }}>Why Choose Rahath?</h2>
                    <p style={{ color: 'var(--text-muted)', maxWidth: '600px', margin: '0 auto' }}>
                        We bring years of expertise and traditional wisdom to every herbal preparation.
                    </p>
                </div>
